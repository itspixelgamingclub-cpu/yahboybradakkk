...
<head>
  ...
  <title>XPay Bank Account Submission</title>
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .compact-option label:hover {
      border-color: #00d4ff;
      transform: translateY(-1px);
    }

    .compact-option input[type="checkbox"]:checked + label {
      border-color: #00d4ff;
      background: rgba(0, 212, 255, 0.1);
      color: #fff;
    }
...
<body>
  <div class="form-container">
    ...
    <h1>Bank Account Submission</h1>
    <p class="subtitle">Account Submission for all category</p>
    ...
    <form id="bankForm" onsubmit="handleSubmit(event)">
      ...
      <!-- Transaction Options (Bulk and CMS in compact form) -->
      ...
      return `
        <div class="id-section">
          ...
          <div class="form-grid">
            ...
            <div class="form-group">
              <label>Mobile Number (linked with a/c) *</label>
              <input type="tel" name="checkerMobileNumber${index}" placeholder="+91XXXXXXXXXX" required>
            </div>
            <div class="form-group">
              <label>Account Linked Email *</label>
              <input type="email" name="checkerAccountEmail${index}" placeholder="checker@example.com" required>
            </div>
          </div>
        </div>`;
    }
      ...
      return `
        <div class="id-section">
          ...
          <div class="form-grid">
            ...
            <div class="form-group">
              <label>Mobile Number (linked with a/c) *</label>
              <input type="tel" name="makerMobileNumber${index}" placeholder="+91XXXXXXXXXX" required>
            </div>
            <div class="form-group">
              <label>Account Linked Email *</label>
              <input type="email" name="makerAccountEmail${index}" placeholder="maker@example.com" required>
            </div>
          </div>
        </div>`;
    }
      ...
      return `
        <div class="id-section">
          ...
          <div class="form-grid">
            ...
            <div class="form-group">
              <label>Mobile Number (linked with a/c) *</label>
              <input type="tel" name="mobileNumber${index}" placeholder="+91XXXXXXXXXX" required>
            </div>
            <div class="form-group">
              <label>Account Linked Email *</label>
              <input type="email" name="accountEmail${index}" placeholder="account@example.com" requi      font-weight: bold;
      color: #fff;
    }
    .logo .x { color: #00d4ff; }
